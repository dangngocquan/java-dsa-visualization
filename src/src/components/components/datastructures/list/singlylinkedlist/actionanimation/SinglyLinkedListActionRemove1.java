...
public class SinglyLinkedListActionRemove1 extends AbstractListAnimation {
    public SinglyLinkedListActionRemove1(AbstractListScreen rootScreen, int period, AbstractListAnimation nextAnimation) {
